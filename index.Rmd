...
## A databservatory should...

- Data across studies, measures
- Link across group characteristics, individuals
- Searching & filtering by individual characteristics, tasks
- Web-based data analysis, visualization; open API
- Consistent framework for ethical data sharing
- Aggregate, clone, track provenance
